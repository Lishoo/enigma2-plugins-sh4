...
class MultiQuickButton(Screen):
	...
	if HD_Res:
		skin = """
		<screen name="MultiQuickButton" position="240,100" size="800,520" title="Multi QuickButton Panel %s" >
		...
		skin = """
		<screen name="MultiQuickButton" position="50,90" size="620,420" title="Multi QuickButton Panel %s" >
	...
	def __init__(self, session, args=None):
		...
		list = []
		list.append(QuickButtonListEntry('1',(_('red'), 'red')))
